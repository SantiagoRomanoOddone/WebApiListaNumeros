...
namespace Middlewares
{
    public class SecurityDisponibilityMiddleware 
    {
        ...
        public SecurityDisponibilityMiddleware(RequestDelegate next,/* IMemoryCache memoryCache,*/ISecurityDisponibilityFilter securityDisponibilityFilter)
        {
            _next = next;
        ...
        #region FeedbackSecurity a borrar
        /*private  async Task<HttpContext>*/
